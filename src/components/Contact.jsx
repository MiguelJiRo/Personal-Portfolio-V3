      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gray-900/50 rounded-xl p-8 md:p-12 border border-gray-700">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h4 className="text-white font-semibold mb-2">Disponibilidad</h4>
                <p className="text-gray-300">Abierto a nuevas oportunidades</p>
              </div>
            </div>

            <div className="border-t border-gray-700 pt-8">
              <h4 className="text-white font-semibold mb-6 text-center">Sígueme en</h4>
              <div className="flex justify-center gap-6">
                <a
                  href="https://github.com/migueljiro"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-14 h-14 bg-gray-700 hover:bg-blue-500 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110"
                >
        ...
        <div className="mt-20 pt-8 border-t border-gray-700 text-center">
          <p className="text-gray-400">
            &copy; {new Date().getFullYear()} Miguel Jiménez Rodríguez. Todos los derechos reservados.
          </p>
