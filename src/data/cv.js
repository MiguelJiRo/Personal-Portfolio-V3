...
export const CV_EDUCATION = [
  {
    role: 'Máster Front-End Lemoncode XIII',
    institution: 'Lemoncode',
    period: 'Abril 2022 - Noviembre 2023',
    description:
...
export const CV_COMPLEMENTARY = [
  {
    role: 'Testing Frontend (20h)',
    institution: 'Icono Training Consulting',
  ...
  {
    role: 'Linux LPIC-1: Linux Administrator (40h)',
